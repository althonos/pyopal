...
project = pyopal.__name__
author = re.match("(.*) <.*>", pyopal.__author__).group(1)
year = datetime.date.today().year
copyright = "{}, {}".format("2022" if year == 2022 else "2022-{}".format(year), author)

# extract the semantic version
semver = semantic_version.Version.coerce(pyopal.__version__)
...
doc_lines = pyopal.__doc__.splitlines()
...
html_theme_options = {
    ...
    "icon_links": [
        ...
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/pyopal",
    ...
    "switcher": {
        "json_url": "https://pyopal.readthedocs.io/en/latest/_static/switcher.json",
